...
public class P1208 {
	private static String input = "834\r\n"
	...
	public static int flatten(int[] heights) {
		int answer = 100;
	...
	public static void main(String[] args) throws IOException {
		...
		for (int tc = 1; tc <= testCase; tc++) {
			...
			dumpCnt = Integer.parseInt(in.readLine());
